...
func unpack(srcRoot, src, destRoot, dest string, ch copy.Chowner, u *copy.User, tm *time.Time, idmap *user.IdentityMapping) (bool, error) {
	...
	if _, err := copy.MkdirAll(dest, 0o755, ch, tm); err != nil {
		return false, err
	}
